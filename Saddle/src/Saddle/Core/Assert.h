...
#define SADDLE_INTERNAL_ASSERT_DEFAULT_MSG(condition) SADDLE_INTERNAL_ASSERT_CHECK(condition, "Assertion failed: %s, file %s, line %s", #condition, std::filesystem::path(__FILE__).filename().string(), std::to_string(__LINE__))
